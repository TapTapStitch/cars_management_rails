...
Car.create(make: 'Lexus', model: 'ES 350', year: 2008, odometer: 121_000, price: 13_000,
           description: 'Sell the car in an ideal condition', added_on: Time.zone.today)
Car.create(make: 'Skoda', model: 'Octavia Tour', year: 2010, odometer: 60_000, price: 8700,
           description: 'For fans and connoisseurs of the skoda brand', added_on: Time.zone.today)
Car.create(make: 'Infiniti', model: 'Q50', year: 2017, odometer: 32_000, price: 21_600,
           description: 'The condition of the car, as with a car dealership', added_on: Time.zone.today)
Car.create(make: 'Audi', model: 'A4', year: 2012, odometer: 103_000, price: 12_500,
           description: 'Audi a4 quattro premium 2012', added_on: Time.zone.today)
...
Car.create(make: 'Audi', model: 'Q7', year: 2012, odometer: 180_000, price: 22_800,
           description: 'Audi q7 3.0 tdi climate control cruise control', added_on: Time.zone.today)
Car.create(make: 'BMW', model: 'X5', year: 2003, odometer: 245_000, price: 10_500,
           description: 'Car in very good condition, LPG installed', added_on: Time.zone.today)
...
Car.create(make: 'Volkswagen', model: 'Passat', year: 2013, odometer: 205_000, price: 12_200,
           description: 'Sell volkswagen passat b7 bluemotion technology', added_on: Time.zone.today)
Car.create(make: 'BMW', model: 'X5', year: 2014, odometer: 130_000, price: 29_900,
           description: 'The car is in perfect condition, fully serviced', added_on: Time.zone.today)
